...
/**
 * Service for managing glucose level readings (rilevazioni).
 * Handles adding new readings, checking for abnormal values, and retrieving
 * data.
 */
...
public class RilevazioneService {
    ...
    public Rilevazione addRilevazione(UUID idPaziente, Double valore, Boolean pasto) {
        ...
        if ((pasto && valore > 180) || (!pasto && valore > 130) || valore < 80) {
