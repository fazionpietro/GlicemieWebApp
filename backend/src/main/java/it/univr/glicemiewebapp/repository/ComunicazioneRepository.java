...
/**
 * Repository for accessing Comunicazione entities.
 */
@Repository
public interface ComunicazioneRepository extends JpaRepository<Comunicazione, UUID> {

  /**
   * Retrieves unread communications for a specific doctor from their patients.
   * 
   * @param idMedico ID of the doctor
   * @return List of ComunicazioneMedicoDTO
   */
  @Query("""
