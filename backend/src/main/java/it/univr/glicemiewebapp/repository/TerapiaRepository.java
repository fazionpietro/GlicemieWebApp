...
/**
 * Repository for accessing Terapia entities.
 */
public interface TerapiaRepository extends JpaRepository<Terapia, UUID> {

    /**
     * Retrieves therapies created by a specific doctor.
     * 
     * @param medicoCurante The doctor who created the therapies
     * @return List of TerapiaDTO
     */
    @Query("""
