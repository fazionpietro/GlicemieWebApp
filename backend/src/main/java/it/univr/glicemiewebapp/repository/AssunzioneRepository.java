...
/**
 * Repository for accessing Assunzione entities.
 */
public interface AssunzioneRepository extends JpaRepository<Assunzione, UUID> {

    /**
     * Retrieves a list of therapy intakes for a specific patient on a given day.
     * Returns a DTO containing therapy details and intake counts.
     * 
     * @param pazienteId ID of the patient
     * @param day        The specific day to filter intakes
     * @return List of AssunzionePazienteDTO
     */
    @Query("""
