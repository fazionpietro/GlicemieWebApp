...
/**
 * Base entity representing a generic user of the system.
 * Handles authentication credentials (email, password) and role-based security.
 * Extended by specific user types like Paziente.
 */
@Entity
@Table(name = "utenti")
