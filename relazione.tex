...
eliminarla dovrà schiacciare il pulsante a forma di cestino e infine può decidere
di crearne una nuova schiacciando il pulsante "Nuova".
...
%inserire descrizione caso d'uso
...
Dopo esssersi autenticate l'admin verra reindirizzato alla sua homepage,
dove troverà:
\begin{itemize}
    \item 
    \item 
