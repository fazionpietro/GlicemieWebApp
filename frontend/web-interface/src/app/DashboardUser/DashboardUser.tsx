 ...
 * Displays glucose charts, recent readings, therapy adherence, and communication options.
 */
  ...
  return (
    <>
      ...
      <Grid columns={24} mb={100} align="stretch">
        <Grid.Col span={{ base: 24, md: 15 }}>
          <Card p="40" pb={130} radius={"md"} shadow='sm' style={{ height: '100%', minHeight: '450px' }}>
        ...
        <Grid.Col span={{ base: 24, md: 9 }}>
          <Grid>
            <Grid.Col>
              <Card p="40" radius={"md"} shadow='sm' style={{ height: '100%', minHeight: '450px' }}>
                <div style={{ height: "100%", minHeight: "350px" }}>
      ...
      <Grid columns={24} mt={100} align="stretch">
        <Grid.Col span={{ base: 24, sm: 12, lg: 8 }}>
          <Card p="40" radius={"md"} shadow='sm' style={{ height: '100%', minHeight: '450px' }}>
            <SegnalaSintomi />
          </Card>
        </Grid.Col>
        ...
        <Grid.Col span={{ base: 24, sm: 24, lg: 8 }}>
          <Card p="40" radius={"md"} shadow='sm' style={{ height: '100%', minHeight: '450px' }}>
            <ContactMedic />
          </Card>
        </Grid.Col>
