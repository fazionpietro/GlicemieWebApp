import { Button, Group, Textarea, Title, Select, SimpleGrid, Checkbox } from '@mantine/core';
...
/**
 * Component for sending messages to the assigned doctor.
 * Patients can choose a priority level for their message.
 */
function ContactMedic() {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      await salvaComunicazione(datiComunicazione);
...
/**
 * Component for reporting specific symptoms.
 * Provides a checklist of common symptoms and an optional note field.
 */
