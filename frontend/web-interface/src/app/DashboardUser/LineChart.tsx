...
/**
 * Component that renders a line chart of the patient's glucose readings over time.
 * Visualizes trends and highlights values outside normal ranges.
 */
  ...
  return (
    <div style={{ height: "100%", width: "100%" }}>
      ...
      {forChartData.length === 0 ? (
        <Paper withBorder shadow="md" p="x1" style={{
        ...
        <LineChart
          ...
          referenceLines={[
            { y: 180, color: "orange", label: 'Soglia massima dopo pasti', strokeDasharray: '5 5' },
            { y: 80, color: "orange", label: 'Soglia minima', strokeDasharray: '5 5' },
            { y: 130, color: "yellow", label: 'Soglia massima stomaco vuoto', strokeDasharray: '5 5' }
          ]}
          yAxisProps={{
            domain: [50, 200],
          }}
                  ...
                  <>
                    {payload.map((item: { name: string; value: number }) => (
                      <Paper px="md" py="sm" withBorder shadow="md" radius="md" ta="left">
                        ...
                        {data.dopoPasto && <Text size="xs" c="dimmed" mb={4}>Dopo pasto</Text>}
